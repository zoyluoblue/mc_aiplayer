...
import React164, {useCallback as useCallback121, useEffect as useEffect71, useMemo as useMemo119} from "react";
...
var RenderQueueContextProvider = ({ children }) => {
  ...
  return jsx15(RenderQueueContext.Provider, {
    value,
    children
  });
};
...
var PreviewServerConnection = ({ children, readOnlyStudio }) => {
  ...
  const context2 = useMemo10(() => {
    return {
      previewServerState: state,
      subscribeToEvent
    };
  }, [state, subscribeToEvent]);
  return jsx16(StudioServerConnectionCtx.Provider, {
    value: context2,
    children
  });
};
...
var SubMenuComponent = ({
  ...
  return jsx22(HigherZIndex, {
    onEscape: onQuitFullMenu,
    onOutsideClick,
    children: jsx22("div", {
      style: portalStyle,
      className: "css-reset",
      children: jsx22(MenuContent2, {
        onNextMenu: noop,
  ...
  return jsx23("div", {
    ...
    children: jsxs3(Row, {
      ...
      children: [
        ...
        subMenu ? jsx23(CaretRight, {}) : null,
        keyHint && !areKeyboardShortcutsDisabled() ? jsx23("span", {
          style: keyHintCss,
          children: keyHint
        }) : null,
        portalStyle && subMenu ? ReactDOM.createPortal(jsx23(SubMenuComponent, {
...
var MenuContent2 = ({
  ...
  return jsx24("div", {
    ...
    children: values.map((item) => {
      if (item.type === "divider") {
        return jsx24(MenuDivider, {}, item.id);
      }
      const onClick = (id, e) => {
        item.onClick(id, e);
        if (item.subMenu) {
...
var InlineDropdown = ({
  ...
  return jsxs4(Fragment2, {
    children: [
      jsx25("div", {
        ref,
        children: jsx25(InlineAction, {
          onClick,
          ...props
        })
      }),
      portalStyle ? ReactDOM2.createPortal(jsx25("div", {
        style: fullScreenOverlay,
        children: jsx25("div", {
          style: outerPortal,
          className: "css-reset",
          children: jsx25(HigherZIndex, {
            onOutsideClick: onHide,
            onEscape: onHide,
            children: jsx25("div", {
              style: portalStyle,
              children: jsx25(MenuContent2, {
                onNextMenu: noop,
                onPreviousMenu: noop,
                values,
                onHide,
...
var ContextMenu = ({ children, values }) => {
  ...
  return jsxs5(Fragment3, {
    children: [
      ...
      portalStyle ? ReactDOM3.createPortal(jsx27("div", {
        style: fullScreenOverlay,
        children: jsx27("div", {
          style: outerPortal,
          className: "css-reset",
          children: jsx27(HigherZIndex, {
            onOutsideClick: onHide,
            onEscape: onHide,
            children: jsx27("div", {
              style: portalStyle,
              children: jsx27(MenuContent2, {
                onNextMenu: noop,
                onPreviousMenu: noop,
                values,
                onHide,
    ...
    return jsxs6(Fragment4, {
      children: [
        jsxs6("button", {
          ...
          children: [
            item.expanded ? jsx30(ExpandedFolderIcon, {
              style: iconStyle,
              color: hovered || selected ? "white" : LIGHT_TEXT
            }) : jsx30(CollapsedFolderIcon, {
              color: hovered || selected ? "white" : LIGHT_TEXT,
              style: iconStyle
            }),
            jsx30(Spacing, {
        ...
        item.expanded ? item.items.map((childItem) => {
          return jsx30(CompositionSelectorItem, {
            currentComposition,
            selectComposition,
            item: childItem,
            tabIndex,
  ...
  return jsx30(ContextMenu, {
    ...
    children: jsx30(Row, {
      ...
      children: jsxs6("a", {
        ...
        children: [
          isCompositionStill(item.composition) ? jsx30(StillIcon, {
            color: hovered || selected ? "white" : LIGHT_TEXT,
            style: iconStyle
          }) : jsx30(FilmIcon, {
            color: hovered || selected ? "white" : LIGHT_TEXT,
          ...
          jsx30(CompositionContextButton, {
            values: contextMenu,
            visible: hovered
          }),
          jsx30(SidebarRenderButton, {
            visible: hovered,
    ...
    children: jsx31("div", {
      ...
      children: jsxs7("div", {
        children: [
          ...
          isCompositionStill(video2) ? jsx31("div", {
            style: subtitle,
            children: "Still"
          }) : jsxs7("div", {
            style: subtitle,
...
var CompositionSelector = () => {
  ...
  return jsxs8("div", {
    style: container7,
    children: [
      showCurrentComposition ? jsx32(CurrentComposition, {}) : null,
      jsx32("div", {
        className: "__remotion-vertical-scrollbar",
        style: list,
        children: items.map((c) => {
          return jsx32(CompositionSelectorItem, {
            level: 0,
...
var ClipboardIcon = ({ color, ...props }) => jsx33("svg", {
  viewBox: "0 0 384 512",
  ...props,
  children: jsx33("path", {
    fill: color,
...
var AssetFolderItem = ({
  ...
  return jsxs9("div", {
    ...
    children: [
      ...
      item.expanded ? jsx35(AssetFolderTree, {
        item: item.items,
        name: item.name,
        level,
        parentFolder,
  ...
  return jsxs9("div", {
    children: [
      ...
      item.files.map((file2) => {
        return jsx35(AssetSelectorItem, {
          item: file2,
          tabIndex,
          level,
          parentFolder: combinedParents
...
var AssetSelector = ({ readOnlyStudio }) => {
  ...
  return jsx36("div", {
    ...
    children: staticFiles.length === 0 ? publicFolderExists ? jsx36("div", {
      style: emptyState,
      children: jsxs10("div", {
        style: label,
        children: [
      ...
      onDragEnter,
      onDragLeave,
      children: jsx36(AssetFolderTree, {
        item: assetTree,
        level: 0,
        parentFolder: null,
        name: null,
...
var ExplorerPanel = ({ readOnlyStudio }) => {
  ...
  return jsxs11("div", {
    ...
    children: [
      ...
      panel === "compositions" ? jsx38(CompositionSelector, {}) : jsx38(AssetSelector, {
        readOnlyStudio
      })
    ]
  });
...
var Combobox = ({ values, selectedId, style: customStyle, title: title2 }) => {
  ...
  return jsxs12(Fragment6, {
    children: [
      ...
      portalStyle ? ReactDOM4.createPortal(jsx41("div", {
        style: fullScreenOverlay,
        children: jsx41("div", {
          style: outerPortal,
          className: "css-reset",
          children: jsx41(HigherZIndex, {
            onOutsideClick: onHide,
            onEscape: onHide,
            children: jsx41("div", {
              style: portalStyle,
              children: jsx41(MenuContent2, {
                onNextMenu: noop,
                onPreviousMenu: noop,
                values,
                onHide,
...
var FilePreview = ({ fileType, src, currentAsset, assetMetadata }) => {
  ...
  if (fileType === "json") {
    return jsx45(JSONViewer, {
      src
    });
  }
  if (fileType === "txt") {
    return jsx45(TextViewer, {
      src
    });
  }
...
var VideoPreview = ({
  ...
  if (contentDimensions === null) {
    return jsx49("div", {
      style: centeredContainer,
      children: jsx49(Spinner, {
        duration: 0.5,
        size: 24
      })
    });
  }
  return jsx49(CompWhenItHasDimensions, {
    contentDimensions,
    canvasSize,
    canvasContent,
    assetMetadata,
...
var CompWhenItHasDimensions = ({
  ...
  return jsx49("div", {
    style: outer,
    children: canvasContent.type === "asset" ? jsx49(StaticFilePreview, {
      assetMetadata,
      currentAsset: canvasContent.asset
    }) : canvasContent.type === "output" ? jsx49(RenderPreview, {
      path: canvasContent.path,
      assetMetadata
    }) : jsx49(PortalContainer, {
      contentDimensions,
      scale,
      xCorrection,
      yCorrection
...
var PortalContainer = ({ scale, xCorrection, yCorrection, contentDimensions }) => {
  const { checkerboard: checkerboard2 } = useContext15(CheckerboardContext);
  ...
  const items = useMemo32(() => {
    return getUniqueSizes(size).map((newSize) => {
      return {
        ...
        leftItem: String(size.size) === String(newSize.size) ? jsx50(Checkmark, {}) : null,
        subMenu: null,
        quickSwitcherLabel: null
      };
    });
...
var InputDraggerForwardRefFn = ({
  ...
  if (inputFallback) {
    return jsx51(HigherZIndex, {
      onEscape,
      onOutsideClick: noop,
      children: jsx51(RemotionInput, {
        ref: fallbackRef,
        autoFocus: true,
        onKeyPress,
        onBlur,
  ...
  return jsxs18(Fragment9, {
    children: [
      jsx54(ControlButton, {
        ...
        children: jsx54(TimelineInPointer, {
      ...
      jsx54(ControlButton, {
        ...
        children: jsx54(TimelineOutPointer, {
...
var pickColor = () => {
  ...
  open.then((color) => {
    copyText(color.sRGBHex).then(() => {
      showNotification(jsxs20(Fragment10, {
        children: [
          jsx57(ColorDot, {
            color: color.sRGBHex
          }),
...
var useMenuStructure = (closeMenu, readOnlyStudio) => {
  ...
  const { checkerboard: checkerboard3, setCheckerboard } = useContext18(CheckerboardContext);
        ...
        items: [
          {
            ...
            subMenu: {
              ...
              items: sizes.map((newSize) => ({
                ...
                label: getPreviewSizeLabel(newSize),
                leftItem: String(newSize.size) === String(size.size) ? jsx58(Checkmark, {}) : null,
                onClick: () => {
                  closeMenu();
                  setSize(() => newSize);
                },
          ...
          },
          {
            ...
            leftItem: editorZoomGestures ? jsx58(Checkmark, {}) : null,
            subMenu: null,
          ...
          },
          {
            ...
            type: "item",
            value: "show-ruler",
            leftItem: editorShowRulers ? jsx58(Checkmark, {}) : null,
            subMenu: null,
          ...
          },
          {
            ...
            type: "item",
            value: "show-guides",
            leftItem: editorShowGuides ? jsx58(Checkmark, {}) : null,
            subMenu: null,
              ...
              items: [
                {
                  ...
                  keyHint: null,
                  label: "Responsive",
                  leftItem: sidebarCollapsedStateLeft === "responsive" ? jsx58(Checkmark, {}) : null,
                  onClick: () => {
                    closeMenu();
                    setSidebarCollapsedState({
                      left: "responsive",
                ...
                },
                {
                  ...
                  keyHint: null,
                  label: "Expanded",
                  leftItem: sidebarCollapsedStateLeft === "expanded" ? jsx58(Checkmark, {}) : null,
                  onClick: () => {
                    closeMenu();
                ...
                },
                {
                  ...
                  keyHint: null,
                  label: "Collapsed",
                  leftItem: sidebarCollapsedStateLeft === "collapsed" ? jsx58(Checkmark, {}) : null,
                  onClick: () => {
                    closeMenu();
                    setSidebarCollapsedState({
                      left: "collapsed",
              ...
              items: [
                {
                  ...
                  keyHint: null,
                  label: "Expanded",
                  leftItem: sidebarCollapsedStateRight === "expanded" ? jsx58(Checkmark, {}) : null,
                  onClick: () => {
                    closeMenu();
                ...
                },
                {
                  ...
                  keyHint: null,
                  label: "Collapsed",
                  leftItem: sidebarCollapsedStateRight === "collapsed" ? jsx58(Checkmark, {}) : null,
                  onClick: () => {
                    closeMenu();
                    setSidebarCollapsedState({
                      left: null,
          ...
          },
          {
            ...
            type: "item",
            value: "checkerboard",
            leftItem: checkerboard3 ? jsx58(Checkmark, {}) : null,
            subMenu: null,
...
var MenuItem = ({
  ...
  return jsxs21(Fragment11, {
    children: [
      ...
      portalStyle ? ReactDOM5.createPortal(jsx59("div", {
        className: "css-reset",
        style: outerStyle,
        children: jsx59(HigherZIndex, {
          onEscape: onItemQuit,
          onOutsideClick: onItemQuit,
          children: jsx59("div", {
            style: portalStyle,
            children: jsx59(MenuContent2, {
...
var OpenEditorButton = ({ type }) => {
  ...
  const openInEditorSvg = jsx60("svg", {
    viewBox: "0 0 512 512",
    style: svgStyle,
    children: jsx60("path", {
      fill: svgFillColor,
...
var MenuBuildIndicator = () => {
  ...
  return jsxs22("div", {
    ...
    children: [
      showButton ? jsx61(Spacing, {
        x: 2
      }) : null,
      isBuilding ? jsx61("div", {
        style: spinner,
        children: jsx61(Spinner, {
          duration: 0.5,
          size: spinnerSize
        })
      }) : jsx61("div", {
      ...
      showButton ? jsx61(OpenEditorButton, {
        type: "editor"
      }) : window.remotion_gitSource ? jsx61(OpenEditorButton, {
        type: "git"
      }) : null
    ]
  });
...
var AskOnDiscord = ({ canHaveKeyboardShortcuts }) => {
  ...
  return jsxs23(Button, {
    onClick: openInBrowser,
    children: [
      "Ask on Discord",
      " ",
      canHaveKeyboardShortcuts ? jsx63(ShortcutHint, {
        keyToPress: "d",
        cmdOrCtrl: true
      }) : null
    ]
...
var ErrorMessage = ({ message }) => {
  ...
  return jsxs25("div", {
    ...
    children: [
      ...
      errorLines !== null && errorLines > maxLines ? jsx67("div", {
        style: moreLine,
        children: jsx67("button", {
          type: "button",
          onClick: toggle,
          style: moreButton,
          children: jsx67(CaretDown2, {
            invert: expanded
          })
        })
      }) : null
...
var ErrorTitle = ({ name, message, symbolicating, canHaveDismissButton }) => {
  return jsxs27("div", {
    ...
    children: [
      jsxs27("div", {
        ...
        children: [
          ...
          jsxs27("div", {
            style: row2,
            children: [
              symbolicating ? jsxs27(Fragment12, {
                children: [
                  jsx69(Symbolicating, {}),
                  jsx69("div", {
                    style: spacer
      ...
      didUnmountReactApp() ? null : canHaveDismissButton ? jsx69(DismissButton, {}) : null
    ]
  });
};
...
var OpenInEditor = ({ stack, canHaveKeyboardShortcuts }) => {
  ...
  return jsxs29(Button, {
    ...
    children: [
      label4,
      canHaveKeyboardShortcuts ? jsx71(ShortcutHint, {
        keyToPress: "o",
        cmdOrCtrl: true
      }) : null
    ]
...
var SearchGithubIssues = ({ message, canHaveKeyboardShortcuts }) => {
  ...
  return jsxs30(Button, {
    onClick: openInBrowser,
    children: [
      "Search GitHub Issues",
      " ",
      canHaveKeyboardShortcuts ? jsx73(ShortcutHint, {
        keyToPress: "g",
        cmdOrCtrl: true
      }) : null
    ]
    ...
    children: [
      jsxs32("div", {
        ...
        children: [
          ...
          s.originalScriptCode && s.originalScriptCode.length > 0 ? jsx75(Button, {
            onClick: toggleCodeFrame,
            children: showCodeFrame ? jsx75(CaretDown2, {
              invert: false
            }) : jsx75(CaretRight2, {})
          }) : null
        ]
      ...
      jsx75("div", {
        children: s.originalScriptCode && s.originalScriptCode.length > 0 && showCodeFrame ? jsx75(CodeFrame, {
          lineNumberWidth,
...
var ErrorDisplay = ({
  ...
  return jsxs33("div", {
    children: [
      ...
      display.stackFrames.length > 0 && window.remotion_editorName ? jsxs33(Fragment13, {
        children: [
          jsx76(OpenInEditor, {
            canHaveKeyboardShortcuts: keyboardShortcuts,
      ...
      calculateMetadata ? jsxs33(Fragment13, {
        children: [
          jsx76("br", {}),
          jsx76(Spacing, {
            y: 0.5
          }),
          jsx76(CalculateMetadataErrorExplainer, {})
        ]
      }) : null,
      jsx76("div", {
        style: stack,
...
var EditorGuides = ({ canvasSize, contentDimensions, assetMetadata }) => {
  ...
  return jsx79(Fragment14, {
    children: guidesForThisComposition.map((guide) => {
      return jsx79(Guide_default, {
        guide,
        canvasDimensions,
        scale
      }, guide.id);
    ...
    children: [
      jsxs36("div", {
        ...
        children: [
          ...
          isFit ? null : jsx83("div", {
            style: resetZoom,
            className: "css-reset",
            children: jsx83(ResetZoomButton, {
              onClick: onReset
            })
          }),
          editorShowGuides && canvasContent.type === "composition" && jsx83(EditorGuides_default, {
            canvasSize: size2,
            contentDimensions,
            assetMetadata: assetResolution
          })
      ...
      areRulersVisible && jsx83(EditorRulers, {
        contentDimensions,
        canvasSize: size2,
        assetMetadata: assetResolution,
...
var RefreshCompositionOverlay = () => {
  return jsx85(AbsoluteFill, {
    style: container19,
    children: jsx85("div", {
      style: shadow,
      children: jsx85(RunningCalculateMetadata, {})
    })
  });
};
...
var CanvasOrLoading = ({ size: size2 }) => {
  ...
  const content = jsxs38(Fragment17, {
    children: [
      jsx86(ZoomPersistor, {}),
      jsx86(Canvas, {
      ...
      resolved?.type === "success-and-refreshing" ? jsx86(RefreshCompositionOverlay, {}) : null
    ]
  });
  ...
  if (resolved.type === "loading") {
    return jsx86("div", {
      style: container20,
      className: "css-reset",
      children: jsx86(RunningCalculateMetadata, {})
    });
  }
  if (resolved.type === "error") {
    return jsx86(ErrorLoading, {
      error: resolved.error
    });
  }
  return jsxs38(Fragment17, {
    children: [
      jsx86(FramePersistor, {}),
      " ",
      content
    ]
  });
...
function MobilePanel({
  ...
  const { currentZIndex } = useZIndex();
  return ReactDOM6.createPortal(jsxs39("div", {
    style: container21,
    children: [
      jsx88("div", {
        style: buttonContainer,
        children: jsx88(CancelButton, {
          style: button2,
          onPress: onClose
        })
      }),
...
var GlobalPropsEditorUpdateButton = ({ compositionId, currentDefaultProps }) => {
  ...
  return jsxs40("div", {
    style: container22,
    children: [
      jsx91(SchemaResetButton, {
        onClick: onReset
      }),
      jsx91(SchemaSaveButton, {
        disabled,
        onClick: onClicked
      })
    ]
...
var ZodProvider = ({ children }) => {
  ...
  return jsx94(ZodContext.Provider, {
    value: contextValue,
    children
  });
};
...
var RenderModalJSONPropsEditor = ({
  ...
  return jsxs43("div", {
    ...
    children: [
      ...
      localValue.validJSON === false ? jsx96(ValidationMessage, {
        align: "flex-start",
        message: localValue.error,
        type: "error"
      }) : localValue.zodValidation.success === false ? jsx96(ZodErrorMessages, {
...
var Fieldset = ({ children, shouldPad }) => {
  ...
  const content = jsx98("div", {
    style: style8,
    children
  });
  if (shouldPad) {
    return jsx98(AlreadyPaddedRightContext.Provider, {
      value: true,
      children: content
    });
  }
...
var SchemaLabel = ({
  ...
  const labelContent = jsxs45("span", {
    style: labelStyle4,
    children: [
  ...
  return jsxs45("div", {
    ...
    children: [
      ...
      jsx100(Flex, {}),
      isDefaultValue ? null : jsx100(SchemaResetButton, {
        onClick: onReset
      }),
      isDefaultValue ? null : showSaveButton ? jsx100(SchemaSaveButton, {
        onClick: onSave,
        disabled: disableSave
      }) : null,
      onRemove ? jsx100(InlineRemoveButton, {
        onClick: onRemove
      }) : null
    ]
  });
...
var InfoTooltip = ({ children, arrowDirection, backgroundColor }) => {
  ...
  return jsxs48("div", {
    ...
    children: [
      ...
      arrowDirection === "down" ? jsx105("svg", {
        viewBox: "0 0 14 7",
        style: arrowDown,
        children: jsx105("path", {
    ...
    children: [
      jsx106("button", {
        ...
        children: jsx106("svg", {
          style: icon3,
          viewBox: "0 0 512 512",
          children: jsx106("path", {
            fill: hovered ? "white" : LIGHT_TEXT,
            d: "M256 48a208 208 0 1 1 0 416 208 208 0 1 1 0-416zm0 464A256 256 0 1 0 256 0a256 256 0 1 0 0 512zM216 336c-13.3 0-24 10.7-24 24s10.7 24 24 24h80c13.3 0 24-10.7 24-24s-10.7-24-24-24h-8V248c0-13.3-10.7-24-24-24H216c-13.3 0-24 10.7-24 24s10.7 24 24 24h24v64H216zm40-144a32 32 0 1 0 0-64 32 32 0 1 0 0 64z"
          })
        })
      }),
      portalStyle ? ReactDOM7.createPortal(jsx106("div", {
        style: outerPortal,
        className: "css-reset",
        children: jsx106(HigherZIndex, {
          onOutsideClick: onHide,
          onEscape: onHide,
          children: jsx106("div", {
            style: portalStyle,
            children: jsx106(InfoTooltip, {
              backgroundColor: INPUT_BACKGROUND,
      ...
      jsx107(InfoBubble, {
        ...
        children: jsxs50("div", {
          ...
          children: [
            ...
            localValue.zodValidation.error.errors.map((error, index) => jsxs50("div", {
              style: stackTraceLabel,
              children: [
                "Type: ",
                error.code,
...
var useLocalState = ({
  ...
  const RevisionContextProvider = useCallback49(({ children }) => {
    return jsx108(RevisionContext.Provider, {
      value: contextValue,
      children
    });
  }, [contextValue]);
...
var ZodArrayEditor = ({
  ...
  return jsxs51(Fieldset, {
    ...
    children: [
      ...
      expanded ? jsx109(RevisionContextProvider, {
        children: jsxs51(SchemaVerticalGuide, {
          isRoot: false,
          children: [
            localValue.value.map((child, i) => {
              return jsxs51(React73.Fragment, {
                children: [
                  jsx109(ZodArrayItemEditor, {
                    onChange,
                    value: child,
                    def,
                    index: i,
                  ...
                  jsx109(SchemaArrayItemSeparationLine, {
                    schema,
                    index: i,
                    onChange,
            ...
            value.length === 0 ? jsx109(SchemaArrayItemSeparationLine, {
              schema,
              index: 0,
              onChange,
              isLast: true
...
var Checkbox = ({ checked, onChange, disabled, name }) => {
  ...
  return jsxs52("div", {
    ...
    children: [
      ...
      jsx110("div", {
        style: box,
        children: checked ? jsx110(Checkmark, {}) : null
      })
    ]
  });
};
        ...
        children: [
          jsxs54(Row, {
            ...
            children: [
              jsx113("div", {
                style: colorPicker,
                children: jsx113(RemInputTypeColor, {
                  type: "color",
                  style: {
                    height: 39
                  },
...
var ZodDiscriminatedUnionEditor = ({
  ...
  const comboBoxValues = useMemo66(() => {
    return options.map((option) => {
      return {
        ...
        id: option,
        keyHint: null,
        leftItem: option === value[typedSchema.discriminator] ? jsx116(Checkmark, {}) : null,
        onClick: () => {
  ...
  return jsx116(ZodObjectEditor2, {
    jsonPath,
    mayPad,
    savedValue: defaultValue,
    onRemove,
  ...
  const comboBoxValues = useMemo67(() => {
    return def.values.map((option) => {
      return {
        ...
        id: option,
        keyHint: null,
        leftItem: option === value ? jsx118(Checkmark, {}) : null,
        onClick: (id) => {
...
var ZodOrNullishEditor = ({
  ...
  return jsxs60(Fieldset, {
    ...
    success: localValue.zodValidation.success,
    children: [
      localValue.value === nullishValue ? jsx120(SchemaLabel, {
        handleClick: null,
        isDefaultValue: localValue.value === defaultValue,
        jsonPath,
        onReset: reset,
...
var ZodOptionalEditor = ({
  ...
  const { innerType } = schema._def;
  return jsx123(ZodOrNullishEditor, {
    defaultValue,
    jsonPath,
    onRemove,
    onSave,
  ...
  const comboBoxValues = useMemo68(() => {
    return getStaticFiles().map((option) => {
      return {
        ...
        id: option.src,
        keyHint: null,
        leftItem: option.src === value ? jsx124(Checkmark, {}) : null,
        onClick: (id) => {
          setLocalValue(() => id, false, false);
        },
        quickSwitcherLabel: null,
  ...
  return jsxs62(Fieldset, {
    ...
    children: [
      ...
      jsx124("div", {
        ...
        children: jsx124(Combobox, {
          values: comboBoxValues,
          selectedId: localValue.value,
          title: value
        })
      }),
      jsx124(ZodFieldValidation, {
        path: jsonPath,
        localValue
      })
    ]
...
var ZodUnionEditor = ({
  ...
  if (options.length > 2) {
    return jsx127(ZonNonEditableValue, {
      jsonPath,
  ...
  return jsx127(ZodOrNullishEditor, {
    defaultValue,
    jsonPath,
    onRemove,
    onSave,
...
var ZodSwitch2 = ({
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodObject) {
    return jsx128(ZodObjectEditor2, {
      setValue,
      unsavedValue: value,
      savedValue: defaultValue,
      jsonPath,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodString) {
    if (value.startsWith(window.remotion_staticBase)) {
      return jsx128(ZodStaticFileEditor, {
        setValue,
        value,
        jsonPath,
        schema,
    ...
    if (zodTypes && schema._def.description === zodTypes.ZodZypesInternals.REMOTION_TEXTAREA_BRAND) {
      return jsx128(ZodTextareaEditor, {
        value,
        setValue,
        jsonPath,
        schema,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodBoolean) {
    return jsx128(ZodBooleanEditor, {
      value,
      setValue,
      jsonPath,
      defaultValue,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodUndefined) {
    return jsx128(ZonNonEditableValue, {
      jsonPath,
      showSaveButton,
      label: "undefined",
      saving,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodOptional) {
    return jsx128(ZodOptionalEditor, {
      jsonPath,
      showSaveButton,
      defaultValue,
      value,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodNullable) {
    return jsx128(ZodNullableEditor, {
      jsonPath,
      showSaveButton,
      defaultValue,
      value,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodDefault) {
    return jsx128(ZodDefaultEditor, {
      jsonPath,
      showSaveButton,
      defaultValue,
      value,
  ...
  if (typeName === z.ZodFirstPartyTypeKind.ZodDiscriminatedUnion) {
    return jsx128(ZodDiscriminatedUnionEditor, {
      defaultValue,
      mayPad,
      schema,
      setValue,
...
var ZodObjectEditor2 = ({
  ...
  return jsxs65(Fieldset, {
    shouldPad: !isRoot && mayPad,
    success: localValue.zodValidation.success,
    children: [
      isRoot ? null : jsx129(SchemaLabel, {
        isDefaultValue,
        onReset: reset,
        jsonPath,
        onRemove,
      ...
      expanded ? jsx129(RevisionContextProvider, {
        children: jsx129(SchemaVerticalGuide, {
          isRoot,
          children: keys.map((key, i) => {
            ...
            return jsxs65(React85.Fragment, {
              children: [
                jsx129(ZodSwitch2, {
                  mayPad: true,
                ...
                i === keys.length - 1 ? null : jsx129(SchemaSeparationLine, {})
              ]
            }, key);
          })
        })
      }) : null,
      isRoot || !expanded ? null : jsx129("div", {
        style: fieldsetLabel,
        children: "}"
      })
    ]
...
var SchemaEditor = ({
  ...
  if (!zodValidationResult.success) {
    ...
    if (!defaultPropsValid.success) {
      return jsx130(InvalidDefaultProps, {
        zodValidationResult
      });
    }
    return jsx130(InvalidSchema, {
      reset,
      zodValidationResult
    });
  }
  if (typeName !== z.ZodFirstPartyTypeKind.ZodObject) {
    return jsx130(TopLevelZodValue, {
  ...
  return jsx130("div", {
    ...
    style: scrollable2,
    className: VERTICAL_SCROLLBAR_CLASSNAME,
    children: jsx130(RevisionContext.Provider, {
      value: revisionState,
      children: jsx130(ZodObjectEditor2, {
        discriminatedUnionReplacement: null,
...
var WarningIndicatorButton = ({ setShowWarning, showWarning, warningCount }) => {
  ...
  return jsxs66("button", {
    type: "button",
    style: buttonStyle3,
    onClick,
    children: [
      jsx131(WarningTriangle2, {
...
var DataEditor = ({
  ...
  if (schema === "no-zod") {
    return jsx132(ZodNotInstalled, {});
  }
  if (schema === "no-schema") {
    return jsx132(NoSchemaDefined, {});
  }
  if (!z) {
    throw new Error("expected zod");
  }
  ...
  return jsxs67("div", {
    ...
    children: [
      jsxs67("div", {
        ...
        children: [
          jsxs67("div", {
            style: tabWrapper,
            children: [
              jsx132(SegmentedControl, {
                items: modeItems,
                needsWrapping: false
              }),
              jsx132(Flex, {}),
              warnings.length > 0 ? jsx132(WarningIndicatorButton, {
                setShowWarning,
                showWarning,
          ...
          showWarning && warnings.length > 0 ? warnings.map((warning) => jsxs67(React88.Fragment, {
            children: [
              jsx132(Spacing, {
                y: 1
              }),
              jsx132(ValidationMessage, {
                message: warning,
                align: "flex-start",
                type: "warning"
              })
      ...
      mode === "schema" ? jsx132(SchemaEditor, {
      ...
      }) : jsx132(RenderModalJSONPropsEditor, {
        value: defaultProps ?? {},
        setValue: setDefaultProps,
        onSave: onUpdate,
        showSaveButton,
...
var RenderQueueItemStatus = ({ job }) => {
  ...
  if (job.status === "running") {
    return jsx137("button", {
      ...
      style: invisibleStyle,
      onClick,
      children: jsx137(CircularProgress, {
...
var RenderQueueOpenInFinderItem = ({ job }) => {
  ...
  const renderAction = useCallback68((color) => {
    return jsx138(ExpandedFolderIconSolid, {
      style: icon4,
      color
    });
  }, [icon4]);
  return jsx138(InlineAction, {
    renderAction,
    onClick
  });
};
    ...
    children: [
      ...
      jsxs68("div", {
        ...
        children: [
          ...
          jsx143("div", {
            style: subtitle2,
            children: job.status === "done" ? jsx143(RenderQueueOutputName, {
              job
            }) : job.status === "failed" ? jsx143(RenderQueueError, {
              job
            }) : job.status === "running" ? jsx143(RenderQueueProgressMessage, {
              job
            }) : null
          })
        ]
      ...
      supportsCopyingToClipboard(job) ? jsx143(RenderQueueCopyToClipboard, {
        job
      }) : null,
      job.status === "done" || job.status === "failed" ? jsx143(RenderQueueRepeatItem, {
        job
      }) : null,
      job.status === "running" ? jsx143(RenderQueueCancelButton, {
        job
      }) : jsx143(RenderQueueRemoveItem, {
        job
      }),
      job.status === "done" ? jsx143(RenderQueueOpenInFinderItem, {
        job
      }) : null
    ]
  });
  ...
  return jsx144("div", {
    ...
    children: jobs.map((j, index) => {
      return jsx144("div", {
        ...
        children: jsx144(RenderQueueItem, {
  ...
  return jsxs71("div", {
    ...
    children: [
      jsx146("div", {
        ...
        children: jsxs71(Tabs, {
          children: [
            composition ? jsxs71(Tab, {
              selected: panel === "input-props",
              onClick: onPropsSelected,
              style: { justifyContent: "space-between" },
              children: [
                "Props",
                unsavedChangesExist ? jsx146(GlobalPropsEditorUpdateButton, {
                  compositionId: composition.id,
                  currentDefaultProps
                }) : null
              ]
            }) : null,
            readOnlyStudio ? null : jsx146(RendersTab, {
      ...
      panel === `input-props` && composition ? jsx146(DataEditor, {
        ...
        setSaving,
        readOnlyStudio
      }, composition.id) : readOnlyStudio ? null : jsx146(RenderQueue, {})
    ]
  });
};
...
var MuteToggle = ({ muted, setMuted }) => {
  ...
  return jsx151(ControlButton, {
    title: accessibilityLabel5,
    "aria-label": accessibilityLabel5,
    onClick,
    children: muted ? jsx151(VolumeOffIcon, {}) : jsx151(VolumeOnIcon, {})
  });
};
...
var PlayPause = ({ playbackRate, loop: loop2, bufferStateDelayInMilliseconds }) => {
  ...
  return jsxs73(Fragment21, {
    children: [
      jsx157(ControlButton, {
        "aria-label": "Jump to beginning",
        title: "Jump to beginning",
        disabled: !videoConfig || isFirstFrame,
        onClick: jumpToStart,
        children: jsx157(JumpToStart, {
          style: backStyle
        })
      }),
      jsx157(ControlButton, {
      ...
      jsx157(ControlButton, {
        ...
        children: playing ? showBufferIndicator ? jsx157(PlayerInternals12.BufferingIndicator, {
          type: "studio"
        }) : jsx157(Pause, {
          style: iconButton
        }) : jsx157(Play, {
...
var PlaybackKeyboardShortcutsManager = ({ setPlaybackRate }) => {
  const keybindings2 = useKeybinding();
  const { play: play2, pause: pause2, playing } = PlayerInternals13.usePlayer();
  ...
  const items = useMemo83(() => {
    ...
    const values = commonPlaybackRates.map((newPlaybackRate) => {
      return {
        ...
        keyHint: null,
        leftItem: String(playbackRate) === String(newPlaybackRate) ? jsx158(Checkmark, {}) : null,
        subMenu: null,
        quickSwitcherLabel: null
      };
    });
    ...
    children: [
      jsxs76("div", {
        ...
        children: [
          ...
          jsx162(TimelineZoomControls, {})
        ]
      }),
      jsx162(Flex, {}),
      jsx162(SizeSelector, {}),
      isStill || isVideoComposition ? jsx162(PlaybackRateSelector, {
        setPlaybackRate,
        playbackRate
      }) : null,
      isVideoComposition ? jsxs76(Fragment22, {
        children: [
          jsx162(Spacing, {
            x: 2
          }),
          ...
          jsx162(TimelineInOutPointToggle, {}),
          jsx162(Spacing, {
            x: 2
          })
        ]
      }) : null,
      jsx162(CheckboardToggle, {}),
      jsx162(Spacing, {
        x: 1
      }),
      isFullscreenSupported && jsx162(FullScreenToggle, {}),
      jsx162(Flex, {}),
      jsxs76("div", {
        style: sideContainer,
        children: [
          ...
          readOnlyStudio ? null : jsx162(RenderButton, {}),
          jsx162(Spacing, {
            x: 1.5
          })
        ]
      }),
      jsx162(PlaybackKeyboardShortcutsManager, {
        setPlaybackRate
      }),
      jsx162(PlaybackRatePersistor, {})
    ]
  });
};
...
var SplitterContainer = ({ orientation, children, defaultFlex, maxFlex, minFlex, id }) => {
  ...
  return jsx163(SplitterContext.Provider, {
    value,
    children: jsx163("div", {
      ref,
...
var TopPanel = ({
  ...
  return jsxs78("div", {
    ...
    children: [
      jsx166("div", {
        style: row4,
        children: jsxs78(SplitterContainer, {
          minFlex: 0.15,
          maxFlex: 0.4,
          defaultFlex: 0.2,
          ...
          orientation: "vertical",
          children: [
            actualStateLeft === "expanded" ? isMobileLayout ? jsx166(MobilePanel, {
              onClose: onCollapseLeft,
              children: jsx166(ExplorerPanel, {
                readOnlyStudio
              })
            }) : jsx166(SplitterElement, {
              sticky: null,
              type: "flexer",
              children: jsx166(ExplorerPanel, {
                readOnlyStudio
            ...
            actualStateLeft === "expanded" ? jsx166(SplitterHandle, {
                ...
                children: [
                  jsx166(SplitterElement, {
                    ...
                    children: jsx166("div", {
                      ...
                      children: size4 ? jsx166(CanvasOrLoading, {
                        size: size4
                      }) : null
                    })
                  }),
                  actualStateRight === "expanded" ? jsx166(SplitterHandle, {
                    allowToCollapse: "right",
                    onCollapse: onCollapseRight
                  }) : null,
                  actualStateRight === "expanded" ? isMobileLayout ? jsx166(MobilePanel, {
                    onClose: onCollapseRight,
                    children: jsx166(OptionsPanel, {
                      readOnlyStudio
                    })
                  }) : jsx166(SplitterElement, {
                    sticky: null,
      ...
      jsx166(PreviewToolbar, {
        bufferStateDelayInMilliseconds,
        readOnlyStudio
      }),
      jsx166(CurrentCompositionKeybindings, {
        readOnlyStudio
      }),
      jsx166(TitleUpdater, {})
    ]
    ...
    children: [
      jsxs80("div", {
        ...
        children: [
          ...
          readOnlyStudio ? null : jsx169(UpdateCheck, {})
        ]
      }),
      jsx169("div", {
        style: flex2
      }),
      jsx169(MenuBuildIndicator, {}),
      jsx169("div", {
        style: flex2
      }),
      jsx169("div", {
        style: fixedWidthRight,
        children: jsx169(SidebarCollapserControls, {})
      }),
      jsx169(Spacing, {
        x: 1
      })
...
var TimelineInOutPointer = () => {
  ...
  return jsxs82(Fragment25, {
    children: [
      inFrame !== null && jsx170("div", {
        ref: inMarkerAreaRef,
        style: {
          ...areaHighlight,
          left: 0,
...
var TimelineInOutPointerHandle = ({
  ...
  return jsx171(InnerTimelineInOutPointerHandle, {
    atFrame,
    dragging,
    timelineWidth,
    type
...
var TimelineDragHandler = () => {
  ...
  return jsx172("div", {
    ref: sliderAreaRef,
    style: containerStyle2,
    children: video2 ? jsx172(Inner2, {}) : null
  });
};
var Inner2 = () => {
  ...
  const { playing, play: play2, pause: pause2, seek } = PlayerInternals15.usePlayer();
  ...
  return jsxs83("div", {
    ...
    children: [
      ...
      inFrame !== null && jsx172(ContextMenu, {
        values: inContextMenu,
        children: jsx172(TimelineInOutPointerHandle, {
          type: "in",
          atFrame: inFrame,
          dragging: inOutDragging.dragging === "in"
        })
      }),
      outFrame !== null && jsx172(ContextMenu, {
...
var TimelineStack = ({ isCompact, sequence }) => {
  ...
  return jsxs84(Fragment26, {
    children: [
      ...
      isCompact || !originalLocation ? null : jsx174("div", {
...
var TimelineListItem = ({ nestedDepth, sequence, isCompact }) => {
  ...
  return jsxs85("div", {
    ...
    children: [
      ...
      sequence.parent && nestedDepth > 0 ? jsx175("div", {
        style: space
      }) : null,
      jsx175(TimelineStack, {
        sequence,
        isCompact
      })
    ]
...
var Inner3 = ({ windowWidth, durationInFrames, fps }) => {
  ...
  return jsx176("div", {
    ...
    children: ticks.map((t) => {
      return jsx176("div", {
        style: t.style,
        children: t.showTime ? jsx176("div", {
          style: tickLabel,
...
var TimelineList = ({ timeline: timeline2 }) => {
  ...
  return jsxs86("div", {
    ...
    style: container37,
    children: [
      jsx177(TimelineTimePadding, {}),
      timeline2.map((track) => {
        return jsx177("div", {
          children: jsx177(TimelineListItem, {
...
var AudioWaveform = ({
  ...
  return jsxs87("div", {
    ...
    children: [
      normalized.map((w) => {
        return jsx180(AudioWaveformBar, {
...
var LoopedTimelineIndicator = ({ loops }) => {
  return jsx182(AbsoluteFill3, {
    style: row6,
    children: new Array(loops).fill(true).map((_l, i) => {
      return jsxs89(React127.Fragment, {
        children: [
          jsx182(Flex, {}),
          i === loops - 1 ? null : jsx182(LoopedIndicator, {})
        ]
      }, i);
    })
  });
...
var Inner4 = ({ s, windowWidth }) => {
  ...
  const video2 = Internals49.useVideo();
  if (!video2) {
  ...
  return jsxs90("div", {
    ...
    children: [
      ...
      s.type === "audio" ? jsx185(AudioWaveform, {
        src: s.src,
      ...
      s.type === "video" ? jsx185(TimelineVideoInfo, {
        src: s.src
      }) : null,
      s.loopDisplay === undefined ? null : jsx185(LoopedTimelineIndicator, {
        loops: s.loopDisplay.numberOfTimes
      }),
      s.type !== "audio" && s.type !== "video" && s.loopDisplay === undefined && (isInRange || isPremounting) ? jsx185("div", {
        style: {
        ...
        children: jsx185(TimelineSequenceFrame, {
...
var TimelineTracks = ({ timeline: timeline2, hasBeenCut }) => {
  ...
  return jsxs91("div", {
    ...
    children: [
      jsxs91("div", {
        ...
        children: [
          ...
          timeline2.map((track) => {
            ...
            return jsx186("div", {
              style: inner2,
              children: jsx186(TimelineSequence, {
                s: track.sequence
              })
            }, track.sequence.id);
          })
      ...
      hasBeenCut ? jsx186(MaxTimelineTracksReached, {}) : null
    ]
  });
};
...
var Timeline = () => {
  ...
  return jsx187("div", {
    ...
    children: jsx187(TimelineWidthProvider, {
      children: jsx187("div", {
        style: inner2,
        children: jsxs92(SplitterContainer, {
          orientation: "vertical",
          defaultFlex: 0.2,
          ...
          minFlex: 0.15,
          children: [
            jsx187(SplitterElement, {
              type: "flexer",
              sticky: jsx187(TimelineTimePlaceholders, {}),
              children: jsx187(TimelineList, {
                timeline: shown
              })
            }),
            jsx187(SplitterHandle, {
              onCollapse: noop7,
            ...
            jsx187(SplitterElement, {
              type: "anti-flexer",
              sticky: null,
              children: jsxs92(TimelineScrollable, {
                children: [
                  jsx187(TimelineTracks, {
                    timeline: shown,
                    hasBeenCut
                  }),
                  jsx187(TimelineInOutPointer, {}),
                  jsx187(TimelinePlayCursorSyncer, {}),
                  jsx187(TimelineDragHandler, {}),
                  jsx187(TimelineTimeIndicators, {}),
                  jsx187(TimelineSlider, {})
                ]
              })
            })
          ]
...
var EditorContent = ({ readOnlyStudio, children }) => {
  ...
  return jsxs93("div", {
    style: container41,
    children: [
      jsx188(InitialCompositionLoader2, {}),
      jsx188(MenuToolbar, {
        readOnlyStudio
      }),
...
var ResolveCompositionBeforeModal = ({ compositionId, children }) => {
  ...
  if (!resolved || resolved.type === "loading") {
    return jsx190(RunningCalculateMetadata, {});
  }
  if (resolved.type === "error") {
    return jsxs95("div", {
  ...
  return jsx190(ResolvedCompositionContext.Provider, {
    value,
    children
  });
};
...
var CodemodFooter = ({
  ...
  const getCanApplyCodemod = useCallback91(async (signal) => {
...
var DeleteComposition = ({ compositionId }) => {
  return jsx195(DismissableModal, {
    children: jsx195(ResolveCompositionBeforeModal, {
      compositionId,
      children: jsx195(DeleteCompositionLoaded, {
        compositionId
      })
    })
  });
...
var NewCompDuration = ({ durationInFrames, setDurationInFrames }) => {
  ...
  const onDurationChangedDirectly = useCallback94((newVal) => {
...
var DuplicateCompositionLoaded = ({ initialType }) => {
  ...
  const onTypeChanged = useCallback95((newType) => {
    setType(newType);
  }, []);
  const onWidthChanged = useCallback95((newValue) => {
    setSize((s) => {
      const { height } = s;
  ...
  const onWidthDirectlyChanged = useCallback95((newWidth) => {
    setSize((s) => {
      const { height } = s;
      return {
        height,
  ...
  const onHeightDirectlyChanged = useCallback95((newHeight) => {
    setSize((s) => {
  ...
  const onHeightChanged = useCallback95((newValue) => {
    setSize((s) => {
      const { width: width2 } = s;
  ...
  const onNameChange = useCallback95((e) => {
    setName(e.target.value);
  }, []);
  const onTextFpsChange = useCallback95((newFps) => {
    setFrameRate(Number(newFps));
  }, []);
  const onFpsChange = useCallback95((newFps) => {
    setFrameRate(newFps);
  }, []);
      ...
      jsxs100("form", {
        ...
        children: [
          jsxs100("div", {
            style: content3,
            children: [
              initialCompType === "composition" ? jsxs100("div", {
                style: optionRow,
                children: [
                  jsx197("div", {
                    style: label5,
              ...
              type === "composition" && hadDurationDefined ? jsx197(NewCompDuration, {
                durationInFrames,
                setDurationInFrames
              }) : null,
              type === "composition" && hadFpsDefined ? jsxs100("div", {
                style: optionRow,
                children: [
                  jsx197("div", {
                    style: label5,
...
var DuplicateComposition = ({ compositionId, compositionType }) => {
  return jsx197(DismissableModal, {
    children: jsx197(ResolveCompositionBeforeModal, {
      compositionId,
      children: jsx197(DuplicateCompositionLoaded, {
...
var RenameComposition = ({ compositionId }) => {
  return jsx198(DismissableModal, {
    children: jsx198(ResolveCompositionBeforeModal, {
      compositionId,
      children: jsx198(RenameCompositionLoaded, {})
    })
  });
};
...
var KeyboardShortcutsExplainer = () => {
  return jsxs102("div", {
    children: [
      areKeyboardShortcutsDisabled() ? jsxs102("div", {
...
import {useEffect as useEffect65, useMemo as useMemo105, useRef as useRef34, useState as useState63} from "react";
import {
jsx as jsx202,
jsxs as jsxs104,
...
var QuickSwitcherResult = ({ result, selected }) => {
  ...
  return jsxs104("div", {
    ...
    children: [
      result.type === "composition" ? result.compositionType === "still" ? jsx202(StillIcon, {
        color: selected ? "white" : LIGHT_TEXT,
        style: iconStyle6
      }) : jsx202(FilmIcon, {
        color: selected ? "white" : LIGHT_TEXT,
...
var QuickSwitcherContent = ({ initialMode, invocationTimestamp, readOnlyStudio }) => {
  ...
  const menuActions = useMemo106(() => {
    if (mode !== "commands") {
      return [];
    }
    return makeSearchResults(actions10, setSelectedModal);
  }, [actions10, mode, setSelectedModal]);
  const resultsArray = useMemo106(() => {
    if (mode === "commands") {
  ...
  const onArrowDown = useCallback97(() => {
    setState((s) => {
      return {
        ...s,
  ...
  const onTextChange = useCallback97((e) => {
  ...
  const onActionsSelected = useCallback97(() => {
    setState((s) => ({
  ...
  const onCompositionsSelected = useCallback97(() => {
    setState((s) => ({
      query: stripQuery(s.query),
      selectedIndex: 0
    }));
  ...
  const onDocSearchSelected = useCallback97(() => {
    setState((s) => ({
      query: `? ${stripQuery(s.query)}`,
      selectedIndex: 0
    }));
  ...
  const container46 = useMemo106(() => {
    return {
      width: showKeyboardShortcuts ? 800 : 500
    };
  }, [showKeyboardShortcuts]);
  const results = useMemo106(() => {
  ...
  return jsxs105("div", {
    ...
    children: [
      ...
      jsx203("div", {
        style: results,
        className: VERTICAL_SCROLLBAR_CLASSNAME,
        children: showKeyboardShortcuts ? jsx203(KeyboardShortcutsExplainer, {}) : showSearchLoadingState ? null : resultsArray.length === 0 ? jsx203(QuickSwitcherNoResults, {
          mode,
          query: actualQuery
        }) : resultsArray.map((result, i) => {
          return jsx203(QuickSwitcherResult, {
...
var QuickSwitcher = ({ initialMode, invocationTimestamp, readOnlyStudio }) => {
  return jsx204(DismissableModal, {
    children: jsx204(QuickSwitcherContent, {
      readOnlyStudio,
      invocationTimestamp,
      initialMode
    })
...
import {useMemo as useMemo107, useState as useState65} from "react";
var useRenderModalSections = (renderMode, codec) => {
  const [selectedTab, setTab] = useState65("general");
  const shownTabs = useMemo107(() => {
    if (renderMode === "audio") {
...
var AudioIcon = (props) => jsx205("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 512 512",
  ...props,
...
var PicIcon = (props) => jsx207("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 512 512",
  ...props,
  children: jsx207("path", {
    fill: "currentcolor",
...
var GearIcon = (props) => jsx208("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 512 512",
  ...props,
  children: jsx208("path", {
    fill: "currentcolor",
...
var GifIcon = (props) => jsx209("svg", {
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 576 512",
  ...props,
  children: jsx209("path", {
    fill: "currentcolor",
...
import {useCallback as useCallback98, useMemo as useMemo108, useState as useState66} from "react";
import {
jsx as jsx210
} from "react/jsx-runtime";
var selectorButton2 = {
...
var VerticalTab = ({ children, onClick, style: style11, selected }) => {
  ...
  const onPointerLeave = useCallback98(() => {
    setHovered(false);
  }, []);
  const definiteStyle = useMemo108(() => {
    return {
      ...selectorButton2,
...
import {useCallback as useCallback99, useEffect as useEffect67, useMemo as useMemo109, useState as useState67} from "react";
import {
jsx as jsx211
} from "react/jsx-runtime";
var svgStyle3 = {
...
var CliCopyButton = ({
  ...
  const fillColor = useMemo109(() => {
    return hovered ? "white" : LIGHT_TEXT;
  }, [hovered]);
  const clipboardIcon = jsx211(ClipboardIcon, {
    color: fillColor,
    style: svgStyle3
  });
  const checkSvg = jsx211("svg", {
    xmlns: "http://www.w3.org/2000/svg",
    viewBox: "0 0 448 512",
    style: svgStyle3,
    children: jsx211("path", {
      fill: fillColor,
        ...
        children: [
          jsxs106("div", {
            ...
            children: [
              ...
              jsx212("div", {
                style: copyWrapper,
                children: jsx212(CliCopyButton, {
                  valueToCopy: option.cliFlag
                })
              })
            ]
          }),
          option.ssrName ? jsxs106("div", {
            style: infoRow,
            children: [
              jsx212("div", {
                style: infoRowLabel,
...
var OptionExplainerBubble = ({ id }) => {
  ...
  return jsx213(InfoBubble, {
    title: "Learn more about this option",
    children: jsx213(OptionExplainer, {
      option
    })
  });
};
...
var NumberSetting = ({ name, value, step, hint, onValueChanged, max, min, formatter }) => {
  ...
  const onValueChange = useCallback100((newConcurrency) => {
  ...
  return jsxs107("div", {
    ...
    children: [
      ...
      jsx214("div", {
        style: rightRow,
        children: jsx214(RightAlignInput, {
          children: jsx214(InputDragger, {
            value,
...
import React145, {useCallback as useCallback102} from "react";
...
var InlineEyeButton = ({ onClick, enabled }) => {
  const renderAction = useCallback101((color) => {
    return enabled ? jsx216("svg", {
      style: clearIcon2,
      viewBox: "0 0 640 512",
      children: jsx216("path", {
        fill: color,
...
var EnvInput = ({
  ...
  const [showInPlainText, setShowInPlainText] = React145.useState(false);
  const [initialWarningKeyMissing, setKeyWarningEligible] = React145.useState(() => {
    return envKey.trim() === "" && envVal.trim() !== "";
  });
  const [initialWarningValMissing, setValueWarningEligible] = React145.useState(() => {
    return envKey.trim() !== "" && envVal.trim() === "";
  });
  ...
  const handleDelete = useCallback102(() => {
    onDelete(index);
  }, [index, onDelete]);
  const togglePlainText = useCallback102(() => {
    setShowInPlainText((prev) => !prev);
  }, []);
  const handleKeyChange = useCallback102((e) => {
    onEnvKeyChange(index, e.target.value);
  }, [index, onEnvKeyChange]);
  const handleValueChange = useCallback102((e) => {
    onEnvValChange(index, e.target.value);
  }, [index, onEnvValChange]);
  const makeKeyWarningEligible = useCallback102(() => {
    setKeyWarningEligible(true);
  }, []);
  const makeValueWarningEligible = useCallback102(() => {
...
var RenderModalEnvironmentVariables = ({ envVariables, setEnvVariables }) => {
  const onEnvValChange = useCallback103((index, value) => {
  ...
  const onEnvKeyChange = useCallback103((index, value) => {
    setEnvVariables((oldEnv) => {
      const newEnv = [...oldEnv];
  ...
  const onDelete = useCallback103((index) => {
    setEnvVariables((oldEnv) => oldEnv.filter((_, idx) => idx !== index));
  }, [setEnvVariables]);
  const addField = useCallback103(() => {
...
var RenderModalAdvanced = ({
  ...
  const extendedOpenGlOptions = useMemo110(() => {
    return [
      "angle",
      "egl",
      "swangle",
  ...
  const onVerboseLoggingChanged = useCallback104((e) => {
  ...
  const toggleCustomUserAgent = useCallback104(() => {
  ...
  const onDisallowParallelEncodingChanged = useCallback104((e) => {
    setDisallowParallelEncoding(e.target.checked);
  }, [setDisallowParallelEncoding]);
  const onDisableWebSecurityChanged = useCallback104((e) => {
    setDisableWebSecurity(e.target.checked);
  }, [setDisableWebSecurity]);
  const onEnableMultiProcessOnLinux = useCallback104((e) => {
    setChromiumMultiProcessOnLinux(e.target.checked);
  }, [setChromiumMultiProcessOnLinux]);
  const onIgnoreCertificatErrors = useCallback104((e) => {
    setIgnoreCertificateErrors(e.target.checked);
  }, [setIgnoreCertificateErrors]);
  const onHeadless = useCallback104((e) => {
    setHeadless(e.target.checked);
  }, [setHeadless]);
  const onUserAgentChanged = useCallback104((e) => {
    setUserAgent(e.target.value);
  }, [setUserAgent]);
  const onPlayBeepSound = useCallback104((e) => {
    setBeep(e.target.checked);
  }, [setBeep]);
  const onReproToggle = useCallback104((e) => {
    setRepro(e.target.checked);
  }, [setRepro]);
  const openGlOptions = useMemo110(() => {
    return extendedOpenGlOptions.map((option) => {
      return {
        label: option === "default" ? "Default" : option,
        onClick: () => setOpenGlOption(option),
        key: option,
        leftItem: openGlOption === option ? jsx220(Checkmark, {}) : null,
        id: option,
        keyHint: null,
        quickSwitcherLabel: null,
        subMenu: null,
  ...
  const x264PresetOptions = useMemo110(() => {
  ...
  const changeOffthreadVideoCacheSizeInBytes = useCallback104((cb) => {
  ...
  return jsxs110("div", {
    ...
    children: [
      ...
      renderMode === "still" ? null : jsx220(NumberSetting, {
        min: minConcurrency,
        max: maxConcurrency,
        step: 1,
        name: "Concurrency",
      ...
      renderMode === "video" && codec === "h264" ? jsxs110("div", {
        style: optionRow,
        children: [
          jsxs110("div", {
            style: label5,
      ...
      renderMode === "audio" ? null : jsxs110("div", {
        style: optionRow,
        children: [
          jsx220("div", {
            style: label5,
      ...
      userAgent === null ? null : jsxs110("div", {
        style: optionRow,
        children: [
          jsx220("div", {
            style: label5,
      ...
      jsx220(RenderModalHr, {}),
      jsx220(RenderModalEnvironmentVariables, {
        envVariables,
        setEnvVariables
      })
    ]
...
var EnforceAudioTrackSetting = ({ enforceAudioTrack, muted, setEnforceAudioTrack }) => {
  const onEnforceAudioTrackChanged = useCallback105((e) => {
...
var MutedSetting = ({ muted, setMuted, enforceAudioTrack }) => {
  const onMutedChanged = useCallback106((e) => {
...
var RenderModalOutputName = ({
  ...
  return jsxs113("div", {
    ...
    children: [
      ...
      jsx223("div", {
        style: rightRow,
        children: jsxs113("div", {
          children: [
            jsx223(RemotionInput, {
...
var SeparateAudioOptionInput = ({ separateAudioTo, setSeparateAudioTo, audioCodec }) => {
  ...
  const onValueChange = useCallback107((e) => {
    setSeparateAudioTo(e.target.value);
  }, [setSeparateAudioTo]);
  const validationMessage = useMemo111(() => {
  ...
  return jsx224(RenderModalOutputName, {
    existence,
    inputStyle: input,
    onValueChange,
...
var SeparateAudioOption = ({ separateAudioTo, setSeparateAudioTo, audioCodec, outName }) => {
  const onSeparateAudioChange = useCallback107((e) => {
    if (e.target.checked) {
  ...
  return jsxs114(Fragment37, {
    children: [
      ...
      separateAudioTo === null ? null : jsx224(SeparateAudioOptionInput, {
        separateAudioTo,
        setSeparateAudioTo,
        audioCodec
      })
...
var RenderModalAudio = ({
  ...
  const onShouldHaveTargetAudioBitrateChanged = useCallback108((e) => {
    setShouldHaveCustomTargetAudioBitrate(e.target.checked);
  }, [setShouldHaveCustomTargetAudioBitrate]);
  const onTargetAudioBitrateChanged = useCallback108((e) => {
    setCustomTargetAudioBitrateValue(e.target.value);
  }, [setCustomTargetAudioBitrateValue]);
  const onSeamlessAacConcatenationChanges = useCallback108((e) => {
    setForSeamlessAacConcatenation(e.target.checked);
  }, [setForSeamlessAacConcatenation]);
  const audioCodecOptions = useCallback108((currentCodec) => {
    return BrowserSafeApis5.supportedAudioCodecs[currentCodec].map((audioCodecOption) => {
      return {
        ...
        leftItem: codec === audioCodecOption ? jsx225(Checkmark, {}) : null,
        id: audioCodecOption,
        keyHint: null,
        quickSwitcherLabel: null,
        subMenu: null,
    ...
    children: [
      renderMode === "video" ? jsxs115(Fragment38, {
        children: [
          ...
          jsx225(RenderModalHr, {})
        ]
      }) : null,
      renderMode === "video" && audioCodecOptions(codec).length >= 2 && !muted ? jsxs115("div", {
        style: optionRow,
        children: [
          jsxs115("div", {
            style: label5,
      ...
      renderMode === "video" && !muted ? jsx225(SeparateAudioOption, {
        separateAudioTo,
        setSeparateAudioTo,
        audioCodec,
        outName
      }) : null,
      audioCodec === "aac" && !muted ? jsxs115("div", {
        style: optionRow,
        children: [
          jsxs115("div", {
            style: label5,
      ...
      renderMode === "still" || muted ? null : jsxs115("div", {
        style: optionRow,
        children: [
          jsxs115("div", {
            style: label5,
      ...
      shouldHaveCustomTargetAudioBitrate && renderMode !== "still" && !muted ? jsxs115("div", {
        style: optionRow,
        children: [
          jsx225("div", {
            style: label5,
...
import {useCallback as useCallback109, useMemo as useMemo112} from "react";
import {
jsx as jsx226,
jsxs as jsxs116
} from "react/jsx-runtime";
...
var MultiRangeSlider = ({
  ...
  const getPercent = useCallback109((value) => Math.round((value - min) / (max - min) * 100), [min, max]);
  const rangeStyle = useMemo112(() => {
  ...
  const onChangeLeft = useCallback109((event) => {
    const value = Math.min(Number(event.target.value), end - 1);
    onLeftThumbDrag(value);
  }, [end, onLeftThumbDrag]);
  const onChangeRight = useCallback109((event) => {
...
var FrameRangeSetting = ({ startFrame, endFrame, setEndFrame, durationInFrames, setStartFrame }) => {
  ...
  const onStartFrameChangedDirectly = useCallback110((newStartFrame) => {
    setStartFrame(newStartFrame);
  }, [setStartFrame]);
  const onEndFrameChangedDirectly = useCallback110((newEndFrame) => {
...
var RenderModalBasic = ({
  ...
  const videoCodecOptions = useMemo113(() => {
    return BrowserSafeApis6.validCodecs.filter((c) => {
      ...
      return {
        ...
        key: codecOption,
        leftItem: codec === codecOption ? jsx228(Checkmark, {}) : null,
        id: codecOption,
        keyHint: null,
        quickSwitcherLabel: null,
        subMenu: null,
  ...
  const proResProfileOptions = useMemo113(() => {
  ...
  const onFrameSetDirectly = useCallback111((newFrame) => {
    setFrame(newFrame);
  }, [setFrame]);
  const onFrameChanged = useCallback111((e) => {
    setFrame((q) => {
  ...
  return jsxs118("div", {
    style: container51,
    children: [
      renderMode === "still" || renderMode === "sequence" ? jsxs118("div", {
        style: optionRow,
        children: [
          jsx228("div", {
            style: label5,
          ...
          jsx228("div", {
            style: rightRow,
            children: jsx228(SegmentedControl, {
      ...
      renderMode === "still" && resolvedComposition.durationInFrames > 1 ? jsxs118("div", {
        style: optionRow,
        children: [
          jsx228("div", {
            style: label5,
          ...
          jsx228("div", {
            style: rightRow,
            children: jsx228(RightAlignInput, {
              children: jsx228(InputDragger, {
                value: frame2,
      ...
      renderMode === "video" && codec === "prores" ? jsxs118("div", {
        style: optionRow,
        children: [
          jsx228("div", {
            style: label5,
      ...
      renderMode === "still" ? null : jsx228(FrameRangeSetting, {
...
var NumberOfLoopsSetting = ({ numberOfGifLoops, setNumberOfGifLoops }) => {
  const onNumberOfGifLoopsChangedDirectly = useCallback112((newConcurrency) => {
    setNumberOfGifLoops(newConcurrency);
  }, [setNumberOfGifLoops]);
  const onNumberOfGifLoopsChanged = useCallback112((e) => {
  ...
  return jsxs119("div", {
    ...
    children: [
      ...
      jsx229("div", {
        style: rightRow,
        children: jsx229(RightAlignInput, {
          children: jsx229(InputDragger, {
...
var RenderModalGif = ({
  ...
  const onShouldLimitNumberOfGifLoops = useCallback113((e) => {
    setLimitNumberOfGifLoops(e.target.checked);
  }, [setLimitNumberOfGifLoops]);
  return jsxs120("div", {
    style: container52,
    children: [
      jsx230(NumberSetting, {
      ...
      limitNumberOfGifLoops ? jsx230(NumberOfLoopsSetting, {
...
import {useCallback as useCallback114, useMemo as useMemo114} from "react";
...
var RenderModalPicture = ({
  ...
  const colorSpaceOptions = useMemo114(() => {
    return BrowserSafeApis7.validColorSpaces.map((option) => {
      return {
        ...
        id: option,
        keyHint: null,
        leftItem: colorSpace === option ? jsx233(Checkmark, {}) : null,
        quickSwitcherLabel: null,
        subMenu: null,
        type: "item",
        value: option
  ...
  const qualityControlOptions = useMemo114(() => {
  ...
  const onTargetVideoBitrateChanged = useCallback114((e) => {
    setCustomTargetVideoBitrateValue(e.target.value);
  }, [setCustomTargetVideoBitrateValue]);
  const onEncodingBufferSizeToggled = useCallback114((e) => {
    setEncodingBufferSize(e.target.checked ? "10000k" : null);
  }, [setEncodingBufferSize]);
  const onEncodingMaxRateToggled = useCallback114((e) => {
    setEncodingMaxRate(e.target.checked ? "5000k" : null);
  }, [setEncodingMaxRate]);
  const onEncodingBufferSizeChanged = useCallback114((e) => {
    setEncodingBufferSize(e.target.value);
  }, [setEncodingBufferSize]);
  const onEncodingMaxRateChanged = useCallback114((e) => {
    ...
    children: [
      renderMode === "video" ? jsxs121("div", {
        ...
        children: [
          ...
          jsx233("div", {
            style: rightRow,
            children: jsx233(SegmentedControl, {
              items: imageFormatOptions,
              needsWrapping: false
            })
          })
      ...
      renderMode === "video" && videoImageFormat === "jpeg" && jsx233(JpegQualitySetting, {
        jpegQuality,
        setJpegQuality
      }),
      renderMode === "still" && stillImageFormat === "jpeg" && jsx233(JpegQualitySetting, {
        jpegQuality,
        setJpegQuality
      }),
      renderMode === "video" && qualityControlType !== null ? jsx233(RenderModalHr, {}) : null,
      shouldDisplayQualityControlPicker && renderMode === "video" ? jsxs121("div", {
        style: optionRow,
        children: [
          jsx233("div", {
            style: label5,
      ...
      qualityControlType === "crf" && renderMode !== "still" && renderMode !== "sequence" ? jsx233(CrfSetting, {
        crf,
        min: minCrf,
        max: maxCrf,
        setCrf,
      ...
      qualityControlType === "bitrate" && renderMode === "video" ? jsxs121("div", {
        style: optionRow,
        children: [
          jsxs121("div", {
            style: label5,
      ...
      renderMode === "video" ? jsxs121(Fragment39, {
        children: [
          ...
          encodingBufferSize === null ? null : jsxs121("div", {
            style: optionRow,
            children: [
              jsx233("div", {
                style: label5,
          ...
          encodingMaxRate === null ? null : jsxs121("div", {
            style: optionRow,
            children: [
              jsx233("div", {
                style: label5,
      ...
      renderMode === "video" ? jsx233(RenderModalHr, {}) : null,
      jsx233(ScaleSetting, {
        scale,
        setScale
      }),
...
var RenderModal = ({
  ...
  const chromiumOptions = useMemo115(() => {
    return {
      headless,
      disableWebSecurity,
      ignoreCertificateErrors,
  ...
  const supportsBothQualityControls = useMemo115(() => {
    return supportsCrf && supportsVideoBitrate;
  }, [supportsCrf, supportsVideoBitrate]);
  const qualityControlType = useMemo115(() => {
  ...
  const dispatchIfMounted = useCallback115((payload) => {
    if (isMounted.current === false)
      return;
    dispatch(payload);
  }, []);
  const muted = useMemo115(() => {
    if (renderMode === "video") {
      return mutedState;
    }
    return false;
  }, [mutedState, renderMode]);
  const enforceAudioTrack = useMemo115(() => {
    if (renderMode === "video") {
  ...
  const deriveFinalAudioCodec = useCallback115((passedVideoCodec, passedAudioCodec) => {
  ...
  const setDefaultOutName = useCallback115((options) => {
  ...
  const setAudioCodec = useCallback115((newAudioCodec) => {
  ...
  const setCodec = useCallback115((newCodec) => {
    if (renderMode === "audio") {
  ...
  const setStillFormat = useCallback115((format) => {
  ...
  const everyNthFrame = useMemo115(() => {
    if (codec === "gif") {
  ...
  const availablePixelFormats = useMemo115(() => {
    return BrowserSafeApis10.validPixelFormatsForCodec(codec);
  }, [codec]);
  const pixelFormat = useMemo115(() => {
  ...
  const onClickVideo = useCallback115(() => {
    setSidebarCollapsedState({ left: null, right: "expanded" });
    persistSelectedOptionsSidebarPanel2("renders");
    optionsSidebarTabs.current?.selectRendersPanel();
    dispatchIfMounted({ type: "start" });
  ...
  const onClickSequence = useCallback115(() => {
    setSidebarCollapsedState({ left: null, right: "expanded" });
    persistSelectedOptionsSidebarPanel2("renders");
    optionsSidebarTabs.current?.selectRendersPanel();
    dispatchIfMounted({ type: "start" });
  ...
  const imageFormatOptions = useMemo115(() => {
    if (renderMode === "still") {
      return [
        {
          label: "PNG",
  ...
  const setRenderMode = useCallback115((newRenderMode) => {
  ...
  const renderTabOptions = useMemo115(() => {
  ...
  const pixelFormatOptions = useMemo115(() => {
    return availablePixelFormats.map((option) => {
      return {
        ...
        id: option,
        keyHint: null,
        leftItem: pixelFormat === option ? jsx234(Checkmark, {}) : null,
        quickSwitcherLabel: null,
        subMenu: null,
        type: "item",
        value: option
  ...
  return jsxs122("div", {
    style: outer4,
    children: [
      jsx234(NewCompHeader, {
        title: `Render ${resolvedComposition.id}`
      }),
      jsxs122("div", {
        style: container54,
        children: [
          jsx234(SegmentedControl, {
      ...
      jsxs122("div", {
        ...
        children: [
          jsxs122("div", {
            style: leftSidebar,
            children: [
              shownTabs.includes("general") ? jsxs122(VerticalTab, {
                style: horizontalTab,
              ...
              shownTabs.includes("data") ? jsxs122(VerticalTab, {
                style: horizontalTab,
                selected: tab === "data",
                onClick: () => setTab("data"),
                children: [
              ...
              shownTabs.includes("picture") ? jsxs122(VerticalTab, {
                style: horizontalTab,
              ...
              shownTabs.includes("audio") ? jsxs122(VerticalTab, {
                style: horizontalTab,
                selected: tab === "audio",
              ...
              shownTabs.includes("gif") ? jsxs122(VerticalTab, {
                style: horizontalTab,
                selected: tab === "gif",
                onClick: () => setTab("gif"),
                children: [
              ...
              shownTabs.includes("advanced") ? jsxs122(VerticalTab, {
                style: horizontalTab,
          ...
          jsx234("div", {
            style: optionsPanel,
            className: VERTICAL_SCROLLBAR_CLASSNAME,
            children: tab === "general" ? jsx234(RenderModalBasic, {
              codec,
              resolvedComposition,
              frame: frame3,
              imageFormatOptions,
            ...
            }) : tab === "picture" ? jsx234(RenderModalPicture, {
              renderMode,
              scale,
              setScale,
              pixelFormat,
              ...
              encodingMaxRate,
              setEncodingMaxRate
            }) : tab === "audio" ? jsx234(RenderModalAudio, {
              muted,
              renderMode,
              setMuted,
              codec,
...
var RenderModalWithLoader = (props) => {
  return jsx234(DismissableModal, {
    children: jsx234(ResolveCompositionBeforeModal, {
      compositionId: props.compositionId,
      children: jsx234(RenderModal, {
        ...props
      })
    })
  });
...
var BundlingProgress = ({ progress, doneIn }) => {
  return jsxs123("div", {
    style: progressItem,
    children: [
      progress === 1 ? jsx236(SuccessIcon, {}) : jsx236(CircularProgress, {
        progress
      }),
      jsx236(Spacing, {
        x: 1
...
var RenderingProgress = ({ progress }) => {
  return jsxs123("div", {
    style: progressItem,
    children: [
      progress.frames === progress.totalFrames ? jsx236(SuccessIcon, {}) : jsx236(CircularProgress, {
...
var OpenFile = ({ job }) => {
  ...
  return jsxs123("div", {
    ...
    children: [
      ...
      jsx236("div", {
        style: right3,
        children: jsx236(RenderQueueOpenInFinderItem, {
          job
        })
      })
    ]
...
var GuiRenderStatus = ({ job }) => {
  ...
  return jsxs123("div", {
    children: [
      ...
      jsx236(BundlingProgress, {
        progress: job.progress.bundling.progress,
        doneIn: job.progress.bundling.doneIn
      }),
      job.progress.rendering ? jsx236(RenderingProgress, {
        progress: job.progress.rendering
      }) : null,
      job.progress.stitching ? jsx236(StitchingProgress, {
        progress: job.progress.stitching
      }) : null,
      job.progress.downloads.length > 0 ? jsx236(DownloadsProgress, {
        downloads: job.progress.downloads
      }) : null,
      job.status === "done" ? jsx236(OpenFile, {
        job
      }) : null,
      jsx236(Spacing, {
        y: 1
...
var RenderStatusModal = ({ jobId }) => {
  ...
  const onQuit = useCallback117(() => {
    setSelectedModal(null);
  }, [setSelectedModal]);
  const onRetry = useCallback117(() => {
    const retryPayload = makeRetryPayload(job);
    setSelectedModal(retryPayload);
  }, [job, setSelectedModal]);
  const onClickOnRemove = useCallback117(() => {
    setSelectedModal(null);
    removeRenderJob(job).catch((err) => {
      showNotification(`Could not remove job: ${err.message}`, 2000);
    });
  }, [job, setSelectedModal]);
  const onClickOnCancel = useCallback117(() => {
    cancelRenderJob(job).catch((err) => {
      showNotification(`Could not cancel job: ${err.message}`, 2000);
    });
  }, [job]);
  ...
  return jsxs124(ModalContainer, {
    onOutsideClick: onQuit,
    onEscape: onQuit,
    children: [
      jsx237(NewCompHeader, {
      ...
      jsxs124("div", {
        ...
        children: [
          ...
          job.status === "done" || job.status === "running" ? jsx237(GuiRenderStatus, {
            job
          }) : null,
          jsx237("div", {
            style: spacer3
          ...
          jsxs124("div", {
            style: buttonRow,
            children: [
              job.status === "running" ? jsx237(Button, {
              ...
              jsx237(Flex, {}),
              job.status === "failed" ? jsx237(Button, {
                onClick: onRetry,
                children: "Retry"
              }) : null,
              jsx237("div", {
...
import {useCallback as useCallback120, useMemo as useMemo118} from "react";

// src/components/CopyButton.tsx
import {useCallback as useCallback118, useEffect as useEffect70, useState as useState71} from "react";
import {
jsx as jsx238,
jsxs as jsxs125
} from "react/jsx-runtime";
...
import {useCallback as useCallback119, useMemo as useMemo117, useState as useState72} from "react";
import {
jsx as jsx239
} from "react/jsx-runtime";
var svgStyle4 = {
...
var OpenIssueButton = ({ link: link3 }) => {
  ...
  const handleClick = useCallback119(() => {
    window.open(link3, "_blank");
  }, [link3]);
  const svgFillColor = useMemo117(() => {
    return hovered ? "white" : LIGHT_TEXT;
  }, [hovered]);
  const openInEditorSvg = jsx239("svg", {
    viewBox: "0 0 512 512",
    style: svgStyle4,
    children: jsx239("path", {
      fill: svgFillColor,
      d: "M320 0c-17.7 0-32 14.3-32 32s14.3 32 32 32h82.7L201.4 265.4c-12.5 12.5-12.5 32.8 0 45.3s32.8 12.5 45.3 0L448 109.3V192c0 17.7 14.3 32 32 32s32-14.3 32-32V32c0-17.7-14.3-32-32-32H320zM80 32C35.8 32 0 67.8 0 112V432c0 44.2 35.8 80 80 80H400c44.2 0 80-35.8 80-80V320c0-17.7-14.3-32-32-32s-32 14.3-32 32V432c0 8.8-7.2 16-16 16H80c-8.8 0-16-7.2-16-16V112c0-8.8 7.2-16 16-16H192c17.7 0 32-14.3 32-32s-14.3-32-32-32H80z"
    })
  });
  const onPointerEnter = useCallback119(() => {
    setHovered(true);
  }, []);
  const onPointerLeave = useCallback119(() => {
    setHovered(false);
  }, []);
  return jsx239("button", {
    title: buttonTooltip,
    type: "button",
    onPointerEnter,
    onPointerLeave,
...
var UpdateModal = ({ info, knownBugs }) => {
  ...
  return jsxs127(DismissableModal, {
    children: [
      jsx241(NewCompHeader, {
...
var Modals = ({ readOnlyStudio }) => {
  ...
  return jsxs128(Fragment42, {
    children: [
      ...
      modalContextType && modalContextType.type === "delete-comp" && jsx242(DeleteComposition, {
        compositionId: modalContextType.compositionId
      }),
      modalContextType && modalContextType.type === "rename-comp" && jsx242(RenameComposition, {
        compositionId: modalContextType.compositionId
      }),
      modalContextType && canRender && modalContextType.type === "render" && jsx242(RenderModalWithLoader, {
      ...
      modalContextType && canRender && modalContextType.type === "render-progress" && jsx242(RenderStatusModal, {
        jobId: modalContextType.jobId
      }),
      modalContextType && modalContextType.type === "update" && jsx242(UpdateModal, {
        info: modalContextType.info,
        knownBugs: modalContextType.knownBugs
      }),
      modalContextType && modalContextType.type === "quick-switcher" && jsx242(QuickSwitcher_default, {
        readOnlyStudio,
...
var Editor = ({ Root, readOnlyStudio }) => {
  ...
  const [canvasMounted, setCanvasMounted] = React164.useState(false);
  const onMounted = useCallback121(() => {
    setCanvasMounted(true);
  }, []);
  const value = useMemo119(() => {
    if (!size4) {
      return null;
    }
    return {
  ...
  const MemoRoot = useMemo119(() => {
    return React164.memo(Root);
  }, [Root]);
  return jsx243(HigherZIndex, {
    onEscape: noop,
    onOutsideClick: noop,
    children: jsxs129(TimelineZoomContext, {
      children: [
        jsx243(Internals57.CurrentScaleContext.Provider, {
          value,
          children: jsxs129("div", {
            style: background2,
            children: [
              canvasMounted ? jsx243(MemoRoot, {}) : null,
...
var PreviewSizeProvider = ({ children }) => {
  ...
  const previewSizeCtx = useMemo120(() => {
    return {
  ...
  return jsx244(Internals58.PreviewSizeContext.Provider, {
...
import {useCallback as useCallback123, useMemo as useMemo121, useState as useState74} from "react";
import {
jsx as jsx245
} from "react/jsx-runtime";
var CheckerboardProvider = ({ children }) => {
  const [checkerboard6, setCheckerboardState] = useState74(() => loadCheckerboardOption());
  const setCheckerboard = useCallback123((newValue) => {
  ...
  const checkerboardCtx = useMemo121(() => {
    return {
      checkerboard: checkerboard6,
      setCheckerboard
    };
  }, [checkerboard6, setCheckerboard]);
  return jsx245(CheckerboardContext.Provider, {
...
var MediaVolumeProvider = ({ children }) => {
  ...
  const mediaVolumeContextValue = useMemo122(() => {
    return {
      mediaMuted,
      mediaVolume
    };
  }, [mediaMuted, mediaVolume]);
  const setMediaVolumeContextValue = useMemo122(() => {
    return {
      setMediaMuted,
      setMediaVolume
    };
  }, []);
  return jsx246(Internals59.MediaVolumeContext.Provider, {
    value: mediaVolumeContextValue,
    children: jsx246(Internals59.SetMediaVolumeContext.Provider, {
...
import {useEffect as useEffect72, useMemo as useMemo124, useState as useState77} from "react";
...
var SetTimelineInOutProvider = ({ children }) => {
  ...
  const setTimelineInOutContextValue = useMemo124(() => {
    return {
      setInAndOutFrames
    };
  }, []);
  ...
  return jsx248(TimelineInOutContext.Provider, {
    value: inAndOutFrames,
    children: jsx248(SetTimelineInOutContext.Provider, {
...
import {useCallback as useCallback124, useMemo as useMemo125, useRef as useRef38, useState as useState78} from "react";
import {
jsx as jsx249
} from "react/jsx-runtime";
var ShowGuidesProvider = ({ children }) => {
  ...
  const setEditorShowGuides = useCallback124((newValue) => {
  ...
  const editorShowGuidesCtx = useMemo125(() => {
    return {
      editorShowGuides,
      setEditorShowGuides,
      guidesList,
  ...
  return jsx249(EditorShowGuidesContext.Provider, {
...
import {useCallback as useCallback125, useMemo as useMemo126, useState as useState79} from "react";
import {
jsx as jsx250
} from "react/jsx-runtime";
var ShowRulersProvider = ({ children }) => {
  const [editorShowRulers, setEditorShowRulersState] = useState79(() => loadEditorShowRulersOption());
  const setEditorShowRulers = useCallback125((newValue) => {
  ...
  const editorShowRulersCtx = useMemo126(() => {
    return {
      editorShowRulers,
      setEditorShowRulers
    };
  }, [editorShowRulers, setEditorShowRulers]);
  return jsx250(EditorShowRulersContext.Provider, {
...
import {useCallback as useCallback126, useMemo as useMemo127, useState as useState80} from "react";
import {
jsx as jsx251
} from "react/jsx-runtime";
var ZoomGesturesProvider = ({ children }) => {
  ...
  const setEditorZoomGestures = useCallback126((newValue) => {
  ...
  const editorZoomGesturesCtx = useMemo127(() => {
    return {
      editorZoomGestures,
      setEditorZoomGestures
    };
  }, [editorZoomGestures, setEditorZoomGestures]);
  return jsx251(EditorZoomGesturesContext.Provider, {
...
var EditorContexts = ({ children, readOnlyStudio }) => {
  return jsx252(ZodProvider, {
    children: jsx252(PreviewServerConnection, {
      readOnlyStudio,
      children: jsx252(RenderQueueContextProvider, {
        children: jsx252(KeybindingContextProvider, {
          children: jsx252(CheckerboardProvider, {
            children: jsx252(ZoomGesturesProvider, {
              children: jsx252(ShowRulersProvider, {
                children: jsx252(ShowGuidesProvider, {
                  children: jsx252(PreviewSizeProvider, {
                    children: jsx252(ModalsProvider, {
                      children: jsx252(MediaVolumeProvider, {
                        children: jsx252(PlayerInternals18.PlayerEmitterProvider, {
                          currentPlaybackRate: null,
                          children: jsx252(SidebarContextProvider, {
                            children: jsx252(FolderContextProvider, {
                              children: jsx252(HighestZIndexProvider, {
                                children: jsx252(SetTimelineInOutProvider, {
                                  children
                                })
                              })
                            })
...
var ServerDisconnected = () => {
  ...
  return jsx253("div", {
    style: container58,
    className: "css-reset",
    children: jsxs130("div", {
      style: message,
      children: [
        "The studio server has disconnected. ",
        jsx253("br", {}),
        window.remotion_studioServerCommand ? jsxs130("span", {
          children: [
            "Run",
            " ",
            jsx253("code", {
...
var Studio = ({ rootComponent, readOnly }) => {
  ...
  return jsx254(Internals61.RemotionRoot, {
    numberOfAudioTags: window.remotion_numberOfAudioTags,
    children: jsxs131(EditorContexts, {
      ...
      children: [
        ...
        readOnly ? null : createPortal(jsx254(ServerDisconnected, {}), getServerDisconnectedDomElement())
      ]
    })
  });
};
